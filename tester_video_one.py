...
def main(num_players, videofile):
    ...
    while(cap.isOpened()):
        ...
        if cv.waitKey(1) == ord('q'):
            ...
            saving_csv(global_res)
            break
        turn = get_turn(screenshot, w, h, mask_circle, num_players)
        cardnum = recog_cardnum(screenshot[210:285, 280:545])
...
ap.add_argument("-f", required=False, help="file path")
